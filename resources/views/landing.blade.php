...
@section('content')
                ...
                <div>
                    ...
                    <div class="mt-6 flex gap-3">
                        @guest
                            ...
                            <a href="{{ route('login') }}"
                                class="px-5 py-3 rounded-xl border border-gray-200 hover:border-indigo-500">
                                Sudah punya akun?
                            </a>
                        @endguest
                        ...
                        @auth
                            <a href="{{ route('dashboard') }}"
                                class="px-5 py-3 rounded-xl bg-gray-900 text-white hover:bg-gray-800">
                                Buka Dashboard
                            </a>
                        @endauth
                    </div>
                ...
                <div class="lg:justify-self-end">
                    <div class="bg-white rounded-2xl shadow-lg p-5 sm:p-6">
                        ...
                        <div class="mt-4 grid sm:grid-cols-2 gap-4">
                            @foreach ([['title' => 'Beach Cleanup Day', 'tag' => 'Volunteer', 'date' => '18 Nov', 'place' => 'Lampung'], ['title' => 'Tech Meetup UI/UX', 'tag' => 'Meetup', 'date' => '20 Nov', 'place' => 'Bandar Lampung'], ['title' => 'Tree Planting', 'tag' => 'Volunteer', 'date' => '23 Nov', 'place' => 'Metro'], ['title' => 'Career Talk', 'tag' => 'Seminar', 'date' => '25 Nov', 'place' => 'Online']] as $e)
                                <div class="border rounded-xl p-4 hover:shadow-md transition">
                                    ...
                                    <button
                                        class="mt-3 w-full px-3 py-2 rounded-lg bg-gray-900 text-white hover:bg-gray-800 text-sm">Lihat
                                        detail</button>
                                </div>
                            @endforeach
                        </div>
                        <a class="mt-4 inline-flex items-center text-sm text-indigo-600 hover:underline"
                            href="#">Lihat semua event →</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div class="mt-6 grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            @foreach ([['t' => 'Daftar Cepat', 'd' => 'Form singkat, langsung dapat tiket/slot volunteer.'], ['t' => 'QR Check-in', 'd' => 'Proses hadir di lokasi jadi cepat & rapi.'], ['t' => 'Sertifikat Otomatis', 'd' => 'Unduh sertifikat pasca-event sekali klik.'], ['t' => 'Ulasan Transparan', 'd' => 'Lihat rating & testimoni peserta sebelumnya.']] as $f)
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 pb-16">
        <div
            class="rounded-2xl bg-indigo-600 text-white p-8 sm:p-10 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
            ...
            <a href="{{ route('register') }}"
                class="px-5 py-3 rounded-xl bg-white text-indigo-700 hover:bg-indigo-50 font-medium">Daftar Organizer</a>
        </div>
    </section>
@endsection
