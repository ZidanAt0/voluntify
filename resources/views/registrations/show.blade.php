                ...
                <div class="p-6">
                    <div class="flex flex-wrap items-center gap-3 text-sm text-gray-700">
                        ...
                        @if ($registration->event->category)
                            <span
                                class="px-2 py-0.5 rounded-full bg-indigo-50 text-indigo-700 ring-1 ring-indigo-200 text-xs">
        ...
        <aside class="space-y-4">
            ...
            @if ($registration->status === 'completed' && $registration->certificate_path)
                <div class="mt-4 p-4 bg-emerald-50 rounded-xl">
                    <p class="text-sm text-gray-600">Sertifikat Kamu:</p>

                    <a href="{{ route('registrations.certificate', $registration) }}"
                        class="mt-2 inline-block w-full text-center bg-emerald-600 hover:bg-emerald-700 text-white px-4 py-2 rounded-xl">
                        🎓 Unduh Sertifikat
                    </a>
                </div>
            @endif
